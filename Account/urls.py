...
urlpatterns = [
    ...
    url(r'^new-login/$',auth_views.login,{"template_name":"registration/login.html"},name="user_login"),
    ...
    url(r'^myself/$',views.myself,{"template_name":"account/myself.html"},name = "myself"),
    url(r'^edit-myself-information/$',views.edit_myself_information,name = "edit_myself_information"),
